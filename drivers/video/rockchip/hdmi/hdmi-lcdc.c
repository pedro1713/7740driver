...
static const struct hdmi_video_timing hdmi_mode [] = {
		//name				refresh		xres	yres	pixclock	h_bp	h_fp	v_bp	        v_fp	h_pw	v_pw				polarity						        PorI	        flag	        vic	        pixelrepeat	interface
...
///	{ {	"1920x1080p@30Hz",	30,			1920,	1080,	74250000,	148,	88,		36,		4,		44,		5,		FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,			0,		0	},	34,		1,		OUT_P888	},
  ...
  { { "854x480p@60Hz",    52,      854,  480,  27000000,   40,   40,  39,  10,    16,   2,    FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,   0, 0    }, 1,   1, OUT_P888	},
};
