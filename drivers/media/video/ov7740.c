...
#define SENSOR_ID1 0x7741
#define SENSOR_ID2 0x7740
...
static int sensor_init(struct v4l2_subdev *sd, u32 val)
{
    ...
    if ((pid == SENSOR_ID)||(pid == SENSOR_ID1)||(pid == SENSOR_ID2)) {
...
*/
	if (((set_w <= 352) && (set_h<= 288)) && sensor_cif[0].reg)
    	{
        winseqe_set_addr = sensor_cif;
        set_w = 352;
        set_h = 288;
...
MODULE_DESCRIPTION(SENSOR_NAME_STRING(Driver));
MODULE_AUTHOR("pedro@po-mo.com");
MODULE_LICENSE("GPL");
