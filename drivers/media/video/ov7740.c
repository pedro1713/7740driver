...
static struct rk_sensor_reg sensor_init_data[] ={
	...
	{ 0x12, 0x10 },//output RAW data RGB mode, default:11
	{ 0xd5, 0x10 },//default value
	{ 0x0c, 0x12 },/*YUV output,YUYV:02 UYVY:12*/
	{ 0x0d, 0x34 },//shows as reserved in datasheet
	{ 0x17, 0x2A },//horizontal output start point, default: 2A
	{ 0x18, 0xa0 },//horizontal output size, default:A0
	{ 0x19, 0x03 },//vertical output start point, default:05
	{ 0x1a, 0xf0 },//vertical output size, default:F0
	{ 0x1b, 0x80 },//pixel shift, default:80
	{ 0x22, 0x03 },//shows as reserved in datasheet
	{ 0x29, 0x17 },//default:18, horizontal tp counter end point
	{ 0x2b, 0xf8 },//default:F8, row counter end point LSB
	{ 0x2c, 0x01 },//default:01, row counter end point MSB
	{ 0x31, 0xa0 },//default:A0, DSP H output size 8 MSB
	{ 0x32, 0xf0 },//default:F0, DSP V output size 8 MSB
	{ 0x33, 0xf4 },//shows reserved
	{ 0x3a, 0xb4 },//default:00, DSP H output size 2 LSB, DSP V ouput size 1 LSB
	{ 0x36, 0x2f },//Reserved

	{ 0x04, 0x60 },//Reserved
	{ 0x27, 0x80 },//[Bit 7] Black sun cancellation enabled, default:00 
	{ 0x3d, 0x0f },//Reserved
	{ 0x3e, 0x82 },//Reserved
	{ 0x3f, 0x40 },//Reserved
	{ 0x40, 0x7f },//Reserved
	...
	{ 0x4e, 0x13 },//Reserved
	{ 0x64, 0x00 },//Reserved
	{ 0x67, 0x88 },//BLC target, default:80
	{ 0x68, 0x1a },//Reserved

	{ 0x14, 0x30 },//AGC Gain ceiling [Bits 6:4], default:30 -- 16x
	{ 0x24, 0x3c },//default:78, WPT Luminance Signal High Range for AEC/AGC operation
	{ 0x25, 0x30 },//default:68, BPT Luminance Signal Low Range for AEC/AGC operation
	{ 0x26, 0x72 },//default:D4, Effective only in AEC/AGC fast mode
	{ 0x50, 0x97 },//default:2E, LSB of banding starting step 50 Hz
	{ 0x51, 0x7e },//default:FC, LSB of banding starting step 60 Hz
	{ 0x52, 0x00 },//default:10, MSB of banding starting step 50/60 Hz
	{ 0x53, 0x00 },//Reserved
	{ 0x20, 0x00 },//Reserved
	{ 0x21, 0x23 },//Reserved
	{ 0x38, 0x14 },//default:10, I2C registers sub-address control bits
	{ 0xe9, 0x00 },//default:00, YAVG control
	{ 0x56, 0x55 },//Y average select for HDR, default: FF
	{ 0x57, 0xff },//Y average select for HDR, default: FF
	{ 0x58, 0xff },//Y average select for HDR, default: FF
	{ 0x59, 0xff },//Y average select for HDR, default: FF
	{ 0x5f, 0x04 },//Reserved
	{ 0xec, 0x00 },//Banding, default: 00
	{ 0x13, 0xff },//default:87, Faster AEC, Enable Frame drop, Banding filter ON, AEC below bading level, Tp level exposure ON, AGC auto, AWB auto, AEC auto

	{ 0x80, 0x7d },//ISP Control, default: 7F, Lens correction disabled
	{ 0x81, 0x3f },//default: 3F
	{ 0x82, 0x32 },//default: 32
	{ 0x83, 0x05 },//default: 09, raw data are from cip s2p first line is BG
	{ 0x38, 0x11 },//I2C registers sub-address control bits
	{ 0x84, 0x70 },//BIST Control, default: 00 bist SRAM done, FIFO SRAM reset
	{ 0x85, 0x00 },//AGC Offset, default: 00
	{ 0x86, 0x03 },//AGC Base1, default: 1E
	{ 0x87, 0x01 },//AGC Base2, default: 02
	{ 0x88, 0x05 },//AGC Control, default: 00
	{ 0x89, 0x30 },//LENC Control, default: 30
	{ 0x8d, 0x30 },//LENC Red A1, default: 22
	{ 0x8f, 0x85 },//LENC Red AB2, default: 87 
	{ 0x93, 0x30 },//LENC Green A1, default: 22
	{ 0x95, 0x85 },//LENC Green AB2, default: 87
	{ 0x99, 0x30 },//Blue A1, default: 22
	{ 0x9b, 0x85 },//Blue AB2, default: 87

	{ 0x9c, 0x08 },//Gamma YST01, default: 0E
	{ 0x9d, 0x12 },//GMA YST02, default: 1A
	{ 0x9e, 0x23 },//GMA YST03, default: 31
	{ 0x9f, 0x45 },//GMA YST04, default: 5A
	{ 0xa0, 0x55 },//GMA YST05, default: 69
	{ 0xa1, 0x64 },//GMA YST06, default: 75
	{ 0xa2, 0x72 },//GMA YST07, default: 7E
	{ 0xa3, 0x7f },//GMA YST08, default: 88
	{ 0xa4, 0x8b },//GMA YST09, default: 8F
	{ 0xa5, 0x95 },//GMA YST10, default: 96
	{ 0xa6, 0xa7 },//GMA YST11, default: A3
	{ 0xa7, 0xb5 },//GMA YST12, default: AF
	{ 0xa8, 0xcb },//GMA YST13, default: C4
	{ 0xa9, 0xdd },//GMA YST14, default: D7
	{ 0xaa, 0xec },//GMA YST15, default: E8
	{ 0xab, 0x1a },//GMA YSLP, default: 20

	{ 0xce, 0x78 },//Color Matrix, default: 41
	{ 0xcf, 0x6e },//Color Matrix, default: CE
	{ 0xd0, 0x0a },//Color Matrix, default: 06
	{ 0xd1, 0x0c },//Color Matrix, default: 17
	{ 0xd2, 0x84 },//Color Matrix, default: 3A
	{ 0xd3, 0x90 },//Color Matrix, default: 52
	{ 0xd4, 0x1e },//Color Matrix Control, default: 5E
